                        ...
                        try:
                            ...
                            if row[0].strip() not in (None,""): 
                                ...
                                if row[9].strip() in (None,""):
                                    ...
                                    search_uom = self.env['product.uom'].search([('name','=',row[9].strip())], limit = 1)
                                    if search_uom:
                                        uom_id = search_uom.id
                                    else:
                                ...
                                if row[10].strip() in (None,""):
                                    ...
                                    search_uom_po = self.env['product.uom'].search([('name','=',row[10].strip())], limit = 1)
                                    if search_uom_po:
                                        uom_po_id = search_uom_po.id
                                    else:
                                ...
                                elif row[15].strip() == 'Invoice based on time and material':
                                    invoicing_policy = 'cost'
                                ...
                                if created_product_tmpl and created_product_tmpl.product_variant_ids and created_product_tmpl.type == 'product' and row[17] != '':
                                    product_id = False
                                    for product in created_product_tmpl.product_variant_ids:
                                    ...
                                    if product_id:
                                        ...
                                        skipped_line_no[str(counter)] = " - Product Varient not found for this template. "
                                        counter = counter + 1
                                        continue                                                                           
                        ...
                        try:
                            ...
                            if sheet.cell(row,0).value.strip()  not in (None,""): 
                                ...
                                if sheet.cell(row,9).value.strip() in (None,""):
                                    ...
                                    search_uom = self.env['product.uom'].search([('name','=',sheet.cell(row,9).value.strip())], limit = 1)
                                    if search_uom:
                                        uom_id = search_uom.id
                                    else:
                                        skipped_line_no[str(counter)] = " - Unit of Measure not found. "                                         
                                ...
                                if sheet.cell(row,10).value.strip() in (None,""):
                                    ...
                                    search_uom_po = self.env['product.uom'].search([('name','=',sheet.cell(row,10).value.strip())], limit = 1)
                                    if search_uom_po:
                                        uom_po_id = search_uom_po.id
                                    else:
                                        skipped_line_no[str(counter)] = " - Purchase Unit of Measure not found. "                                         
                                ...
                                if sheet.cell(row,15).value.strip() == 'Delivered quantities':
                                    invoicing_policy = 'delivery'
                                elif sheet.cell(row,15).value.strip() == 'Invoice based on time and material':
                                    invoicing_policy = 'cost'                                    
