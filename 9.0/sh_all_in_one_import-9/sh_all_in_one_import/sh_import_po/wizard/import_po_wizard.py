...
class import_po_wizard(models.TransientModel):
    ...
    def show_success_msg(self,counter, confirm_rec, skipped_line_no):
        ...
        action = self.env.ref('sh_all_in_one_import.sh_import_po_action').read()[0]
                    ...
                    for row in myreader:
                        try:
                            ...
                            if row[0] not in (None,"") and row[4] not in (None,""): 
                                ...
                                if row[0] != running_po:
                                    ...
                                    if row[1] not in (None,""):
                                        ...
                                        if partner:
                                            ...
                                            if not partner:
                                                skipped_line_no[str(counter)]= " - Vendor not created. " 
                                                counter = counter + 1 
                                                continue
                                            else:
                                                po_vals.update({'partner_id' : partner.id})
                                        else:
                                            skipped_line_no[str(counter)]= " - Vendor not found. " 
                                            counter = counter + 1 
                                            continue   
                                    else:
                                        skipped_line_no[str(counter)]= " - Vendor field is empty. " 
                                        counter = counter + 1 
                                        continue     
                                ...
                                skipped_line_no[str(counter)] = " - Purchase Order or Product field is empty. "  
                                counter = counter + 1      
                            ...
                            counter = counter + 1 
                            continue          
                    if created_po_list_for_confirm and self.is_confirm_order == True:
                        ...
                        try:
                            ...
                            if sheet.cell(row,0).value not in (None,"") and sheet.cell(row,4).value not in (None,""): 
                                ...
                                if sheet.cell(row,0).value != running_po:
                                    ...
                                    if self.order_no_type == 'as_per_sheet':
                                        po_vals.update({"name" : sheet.cell(row,0).value})                           
                                    created_po = purchase_order_obj.create(po_vals) 
                                    created_po_list_for_confirm.append(created_po.id)
                                    created_po_list.append(created_po.id)
