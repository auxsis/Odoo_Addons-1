...
class import_int_transfer_wizard(models.TransientModel):
    ...
    def show_success_msg(self,counter,skipped_line_no):
        ...
        action = self.env.ref('sh_all_in_one_import.sh_import_int_transfer_action').read()[0]
                            ...
                            if row[0] not in (None,""): 
                                ...
                                if search_product and search_product.type in ['product','consu']:
                                    ...
                                    if row[1] not in (None,""):
                                        vals.update({'product_uom_qty' : row[1]})
                                    else:
                                    ...
                                    if created_picking:
                                        vals.update({
                                            ...
                                            'date_expected'    : created_picking.min_date
                                        })
                                        ...
                                        if created_stock_move:
                                            ...
                                            if row[1] not in (None,""):
                                                created_stock_move.write({'product_uom_qty' : row[1]})
                                    ...
                                    if created_picking:
                                        ...
                                        if created_stock_move:
                                            ...
                                            if search_uom:
                                                created_stock_move.write({'product_uom' : search_uom.id})
                                            if sheet.cell(row,1).value not in (None,""):
                                                created_stock_move.write({'product_uom_qty' : sheet.cell(row,1).value})                                                
